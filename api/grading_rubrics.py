...
RUBRICS = {
    ...
    "L01_independent_expository": {
        ...
        "criteria": [
            ...
            {
                "id": "content_quality",
                "name": "Provides specific, substantive information",
                "description": "Supporting sentences include at least one concrete detail — a specific fact, statistic, example, or named entity. Vague generalities like 'it costs money' or 'there are many benefits' without any specifics do NOT meet this criterion.",
                "weight": 2,
            },
        ],
        "common_pitfalls": [
            ...
            "All sentences are vague generalities with no concrete details, examples, or specifics",
        ],
        "min_words": 50,
    },
    ...
    "L01_independent_argumentative": {
        ...
        "criteria": [
            ...
            {
                "id": "content_quality",
                "name": "Provides specific reasons or evidence",
                "description": "Supporting sentences include at least one concrete reason, specific example, or named piece of evidence. Vague claims like 'it would help a lot' or 'there are many reasons' without any specifics do NOT meet this criterion.",
                "weight": 2,
            },
        ],
        "common_pitfalls": [
            ...
            "All reasoning is vague ('it would be good', 'there are benefits') with no concrete examples or specifics",
        ],
        "min_words": 50,
    },
