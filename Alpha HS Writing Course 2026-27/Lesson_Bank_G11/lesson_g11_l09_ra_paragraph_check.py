...
LESSON = Lesson(
    ...
    slots=[
        ...
        Slot("SUPPORTED", "production_frq", "Revise the summary paragraph into analysis",
             ref="", bank="douglass_1852", rubric_ref="rc.4trait", scored=True, unit="paragraph", frq_type="revision",
             body=frq_prompt(
        ...
        Slot("TRANSFER", "production_frq", "Revise a summary paragraph on a NEW text",
             ref="", bank="ra_speech_1", rubric_ref="rc.4trait", scored=True, unit="paragraph", frq_type="revision",
             body=frq_prompt(
