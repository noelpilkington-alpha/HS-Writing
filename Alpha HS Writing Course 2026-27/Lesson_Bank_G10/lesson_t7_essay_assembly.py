    ...
    slots=[
        ...
        Slot("TEACH", "teach_card", "Why a plan beats a plunge (BUILD, and the three phases)",
             body=("On the test you have one source set, one prompt, and a single sitting to produce a whole "
                   ...
                   "which side can you defend from the source), Underline the SPO plan (write a one-line "
                   "thesis, then list your body points in order with the evidence each will use), Lay out "
                   "paragraphs (turn each outline line into a paragraph), Integrate (bring in the moves you "
