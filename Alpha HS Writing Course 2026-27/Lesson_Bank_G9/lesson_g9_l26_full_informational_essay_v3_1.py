    ...
    slots=[
        ...
        Slot("TEACH", "teach_card", "The one idea: an explanation is a plan built out, with no side",
             body=(ONE_IDEA +
                   ...
                   "<ol style=\"color:#1f2a44;font-size:14px;margin:6px 0 0;padding-left:22px\">"
                   "<li style=\"margin:5px 0\"><strong>PLAN, at two levels</strong>: the single-paragraph outline "
                   "you know plans ONE paragraph; an essay needs the bigger multiple-paragraph outline. It is a "
                   "controlling idea on top, then one line per body paragraph naming its part and its evidence, "
                   "in the order the parts build, framed by an intro and a conclusion. A controlling idea means "
                   "one sentence that names the focus your explanation will take, with no side.</li>"
