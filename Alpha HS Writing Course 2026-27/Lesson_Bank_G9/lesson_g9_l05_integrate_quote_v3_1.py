    ...
    slots=[
        ...
        Slot("TEACH", "teach_card", "Three ways to bring in a source, and always name who said it",
             body=(ONE_IDEA +
                   ...
                   "briefly, in your own words. Best when you need the big picture in a line or two, so you will "
                   "reach for it most when you write from a whole source later; here the focus is the quote and "
                   "the paraphrase, the two you use to bring in a single piece of evidence.</li></ul>"
